...
const Subscribe = () => {
    return (
        <section className="max-continer flex justify-center items-center max-lg:flex-col gap-10" id="subscribe">
            <h3 className="text-4xl leading-[68px] lg:max-w-md font-palanquin font-bold">Sign Up
                for <span className="text-coral-red">Updates</span> & NewsLetter</h3>
            <div
